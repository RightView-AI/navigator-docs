...
- **Faster, simpler data platform** - consolidate Navigator's data on MongoDB Atlas to simplify storage and improve reliability.
- **Privacy-safe usage tracing** - re-introduce internal usage tracing with patient identifiers removed before any data leaves Navigator.
- **Continued compliance work** - SOC 2 Type 1 controls, scheduled data-retention enforcement, and tighter database network access.
