...
- **HIPAA readiness** - Navigator stores your site's operational data with HIPAA-aligned protections, and keeps only de-identified data in the audit trail and the search index.
